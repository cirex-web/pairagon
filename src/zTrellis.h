...
struct zTrellis {
	...
	zScanner        **alignmentscanner;
	zScanner        **ralignmentscanner;
...
score_t zGetLocalTransitionScore(zTrellis*, int, int,coor_t);
score_t zGetLocalIntergenicContinueScore(zTrellis*,coor_t);
